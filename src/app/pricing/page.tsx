    ...
    const tiers = [
        {
            ...
            price: "$0",
            period: "/mo",
            desc: "Standard Support. Basic Report.",
            features: ["1 Scan / Month", "Standard Support", "Basic Stoplight Report"],
            cta: "Start Scanning",
            icon: Star,
            highlight: false
        },
        {
            ...
            price: "$49",
            period: "/scan",
            desc: "High-Fidelity Analysis. One-Time.",
            features: ["Single High-Fidelity Scan", "Full Curative Analysis", "24-Hour Data Retention"],
            cta: "Secure My Deal",
            icon: CreditCard,
            highlight: false
        },
        {
            ...
            price: "$150",
            period: "/mo",
            desc: "Unlimited. Priority. Advanced.",
            features: ["Unlimited Scans", "Priority AI Processing", "Advanced 'Heirship' Logic", "Dashboard Analytics"],
            cta: "Scale My Volume",
            icon: Zap,
            highlight: true,
            badge: "Best Value"
