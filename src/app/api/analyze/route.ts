...
export async function POST(req: NextRequest) {
    try {
      ...
      - CALIFORNIA (Federal FinCEN Reporting): Trigger: Residential transaction (1-4 units), Purchase is non-financed (Cash), and Buyer is a legal entity (LLC, Corp, Trust). Action Step (Red Light): "NEW FEDERAL LAW: As of March 1, 2026, FinCEN requires mandatory reporting for non-financed entity purchases. Curative: The closing agent must file a Real Estate Report within 30 days. Failure to provide Beneficial Ownership Information (BOI) is a federal compliance violation."
      - CALIFORNIA (AI-Generated Listing Disclosure): Trigger: System detects marketing materials or photos within the analysis request that appear digitally altered or AI-staged. Action Step (Yellow Light): "CA Law AB 945: Effective Jan 1, 2026, all listing photos that have been digitally altered or AI-generated must be clearly disclosed. Curative: Ensure the listing includes the mandatory disclaimer: 'Image has been digitally altered or AI-generated.' Failing to disclose is a violation of the Consumer Legal Remedies Act."
      - CALIFORNIA (Solar & PACE Lien Priority): Trigger: Presence of 'PACE', 'HERO', or 'UCC-1' in Schedule B Exceptions. Action Step (Red Light): "California PACE liens are 'Super-Priority' liens collected via property tax bills. Curative: Most lenders will NOT fund unless the PACE lien is paid off in full at closing. Verify the payoff amount and ensure it is listed on the Closing Disclosure (CD)."
      - CALIFORNIA (Wildfire Disclosure & Home Hardening): Trigger: Property is in a 'High' or 'Very High' Fire Hazard Severity Zone. Action Step (Yellow Light): "SB 429 Update (2026): Sellers must provide a wildfire risk report and a checklist of 'Zone Zero' (5-ft perimeter) hardening measures. Curative: Verify the seller has provided the 'Home Fire Hardening Disclosure and Advisory' (FHDS). Recommend the buyer check for eligibility for the 2026 CA Safe Homes Act grant program for roof upgrades."
      - CALIFORNIA (Restrictive Covenant Removal): Trigger: Detection of outdated CC&Rs or restrictive covenants in Schedule B. Action Step (Yellow Light): "NEW LAW: AB 1050 (Effective 2026) expands the ability to remove restrictive covenants that block housing density. Curative: If the client intends to develop/subdivide, they can now utilize an expedited modification process to strip unenforceable density restrictions from the title."
        ...
        if (!apiKey) {
            ...
            return NextResponse.json({
                ...
                curative_actions: [
                    {
                        priority: "HIGH",
                        instruction: "File FinCEN Real Estate Report within 30 days and collect BOI.",
                        reason: "Cash transactions for LLCs are subject to strict new federal FinCEN regulations."
                    }
                ],
                geographic_intelligence: {
                    state: "CA",
                    action_step: "NEW FEDERAL LAW: As of March 1, 2026, FinCEN requires mandatory reporting for non-financed entity purchases. Curative: The closing agent must file a Real Estate Report within 30 days. Failure to provide Beneficial Ownership Information (BOI) is a federal compliance violation.",
                    risk_level: "RED"
                }
            });
        }
