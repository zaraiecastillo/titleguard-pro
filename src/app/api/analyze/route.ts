        ...
        if (!apiKey) {
            ...
            return NextResponse.json({
                ...
                curative_actions: [
                    {
                        priority: "HIGH",
                        instruction: "File Release of Lis Pendens and resolve underlying court action.",
                        reason: "Active litigation currently clouds the title, preventing a clean transfer."
                    }
                ],
                geographic_intelligence: {
                    state: "NY",
                    action_step: "NY is a judicial foreclosure state. A Lis Pendens indicates a court action is pending. Curative: A 'Release of Lis Pendens' must be filed by the plaintiff’s attorney. Note: Judicial timelines in NY are currently 9–12 months. This deal is unlikely to close on schedule.",
                    risk_level: "RED"
                }
            });
        }
