...
export function Navbar() {
    ...
    return (
        <>
            <nav className={`fixed top-0 left-0 w-full z-[110] transition-all duration-300 ${isOpen ? 'bg-transparent border-b-transparent' : 'backdrop-blur-lg bg-black/40 border-b border-white/10'}`}>
